                ...
                <div class="wrapper">
                    ...
                    <div class="block_option">
                        <form id="objectives_form" method="POST" name="objectives_form">
                            ...
                            <input type="text" name="objectives_name_input" class="objectives_input" id="objectives_name_input" placeholder="Название задачи">
                            <input type="text" name="objectives_description_input" class="objectives_input" id="objectives_description_input" placeholder="Описание задачи">
                            <div class="clearfix"></div>
